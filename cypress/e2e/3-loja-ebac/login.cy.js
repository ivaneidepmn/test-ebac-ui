...
it('Deve fazer login com sucesso - usando massa de dados', () => {
    ...
    cy.get('.woocommerce-form > .button').click()
    cy.get('.woocommerce-MyAccount-content > :nth-child(2)').should('contain', `Olá, ${perfil.usuario} (não é ${perfil.usuario}? Sair)`)
});
it.fixture('Deve fazer login com sucesso - usando fixtures', () => {
